...
/// Accountancy business.\n\nAs a [SchemaLocalBusiness] it can be described
/// as a [Schemaprovider] of one or more [SchemaService]\(s).
...
class SchemaAccountingService implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaAccountingService]
  SchemaAccountingService({
