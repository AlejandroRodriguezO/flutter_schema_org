...
class SchemaAdministrativeArea implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaAdministrativeArea]
  ...
  /// Serialize [SchemaAdministrativeArea] to JSON-LD
  @override
