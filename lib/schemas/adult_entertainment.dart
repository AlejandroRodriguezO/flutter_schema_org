...
class SchemaAdultEntertainment implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaAdultEntertainment]
  SchemaAdultEntertainment({
    this.branchOf,
  ...
  /// Serialize [SchemaAdultEntertainment] to JSON-LD
  @override
