...
class SchemaAllocateAction implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaAllocateAction]
  SchemaAllocateAction({
    this.actionStatus,
    this.agent,
    this.endTime,
    this.error,
  ...
  /// Serialize [SchemaAllocateAction] to JSON-LD
  @override
