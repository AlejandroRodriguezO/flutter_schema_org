...
/// An AnalysisNewsArticle is a [SchemaNewsArticle] that, while based on
...
class SchemaAnalysisNewsArticle implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaAnalysisNewsArticle]
  SchemaAnalysisNewsArticle({
    this.dateline,
    this.printColumn,
    this.printEdition,
    this.printPage,
  ...
  /// Serialize [SchemaAnalysisNewsArticle] to JSON-LD
  @override
