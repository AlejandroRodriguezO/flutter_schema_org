...
class SchemaAnswer implements SchemaSerializable {
  ...
  /// about it.
  ///
  /// Supported types: [SchemaComment], [SchemaWebContent]
  ...
  /// being an [SchemaArticle] or other [SchemaCreativeWork]. See also
  /// [Schemacomment] which points from something to a comment about it.
  ///
  ...
  /// Create a new instance of [SchemaAnswer]
  SchemaAnswer({
  ...
  Map<String, dynamic> toJsonLd() => removeEmpty({
        ...
        'answerExplanation': convertToJsonLd(
            answerExplanation, [SchemaComment, SchemaWebContent]),
        'parentItem':
