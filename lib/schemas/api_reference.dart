...
class SchemaAPIReference implements SchemaSerializable {
  ...
  /// phone, Metro style, desktop, XBox, etc.
  ...
  /// Create a new instance of [SchemaAPIReference]
  SchemaAPIReference({
    this.assembly,
    this.assemblyVersion,
    this.executableLibraryName,
  ...
  Map<String, dynamic> toJsonLd() => removeEmpty({
        ...
        'proficiencyLevel': convertToJsonLd(proficiencyLevel, [String]),
