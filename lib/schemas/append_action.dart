...
class SchemaAppendAction implements SchemaSerializable {
  ...
  /// A sub property of object. The collection target of the action.
  SchemaThing? targetCollection;

  /// Create a new instance of [SchemaAppendAction]
  SchemaAppendAction({
    this.toLocation,
    this.actionStatus,
    this.agent,
  ...
  /// Serialize [SchemaAppendAction] to JSON-LD
  @override
