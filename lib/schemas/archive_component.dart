...
import 'package:flutter_schema_org/schemas/archive_organization.dart';
...
/// An intangible type to be applied to any archive content, carrying with it
/// a set of properties required to describe archival items and collections.
/// See https://schema.org/ArchiveComponent
class SchemaArchiveComponent implements SchemaSerializable {
  /// [SchemaArchiveOrganization] that holds, keeps or maintains the
  /// [SchemaArchiveComponent].
  ...
  /// Create a new instance of [SchemaArchiveComponent]
  SchemaArchiveComponent({
    this.holdingArchive,
    this.itemLocation,
    this.about,
