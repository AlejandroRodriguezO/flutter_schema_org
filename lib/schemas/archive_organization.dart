...
import 'package:flutter_schema_org/schemas/archive_component.dart';
...
class SchemaArchiveOrganization implements SchemaSerializable {
  ...
  /// kept or maintained by an [SchemaArchiveOrganization].
  ...
  /// Create a new instance of [SchemaArchiveOrganization]
  SchemaArchiveOrganization({
    this.archiveHeld,
    this.branchOf,
