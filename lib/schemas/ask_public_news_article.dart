...
/// A [SchemaNewsArticle] expressing an open call by a
/// [SchemaNewsMediaOrganization] asking the public for input, insights,
/// clarifications, anecdotes, documentation, etc., on an issue, for
/// reporting purposes.
/// See https://schema.org/AskPublicNewsArticle
class SchemaAskPublicNewsArticle implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaAskPublicNewsArticle]
  SchemaAskPublicNewsArticle({
    this.dateline,
    this.printColumn,
    this.printEdition,
    this.printPage,
  ...
  /// Serialize [SchemaAskPublicNewsArticle] to JSON-LD
  @override
