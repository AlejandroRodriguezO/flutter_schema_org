...
import 'package:flutter_schema_org/schemas/book_format_type.dart';
...
class SchemaAudiobook implements SchemaSerializable {
  ...
  SchemaBookFormatType? bookFormat;

  /// The illustrator of the book.
  SchemaPerson? illustrator;
  ...
  /// Create a new instance of [SchemaAudiobook]
  SchemaAudiobook({
    this.duration,
    this.readBy,
    this.caption,
