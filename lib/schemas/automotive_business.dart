...
class SchemaAutomotiveBusiness implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaAutomotiveBusiness]
  SchemaAutomotiveBusiness({
    this.branchOf,
  ...
  /// Serialize [SchemaAutomotiveBusiness] to JSON-LD
  @override
