...
/// //en.wikipedia.org/wiki/FAQ)) document on topics such as Climate Change
/// or the European Union. Other kinds of background material from a non-news
/// setting are often described using [SchemaBook] or [SchemaArticle], in
/// particular [SchemaScholarlyArticle]. See also [SchemaNewsArticle] for
/// related vocabulary from a learning/education perspective.
/// See https://schema.org/BackgroundNewsArticle
class SchemaBackgroundNewsArticle implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaBackgroundNewsArticle]
  SchemaBackgroundNewsArticle({
    this.dateline,
    this.printColumn,
    this.printEdition,
    this.printPage,
  ...
  /// Serialize [SchemaBackgroundNewsArticle] to JSON-LD
  @override
