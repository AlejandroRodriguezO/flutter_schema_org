...
class SchemaBankOrCreditUnion implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaBankOrCreditUnion]
  SchemaBankOrCreditUnion({
  ...
  /// Serialize [SchemaBankOrCreditUnion] to JSON-LD
  @override
