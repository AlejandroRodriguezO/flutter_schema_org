...
class SchemaBedAndBreakfast implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaBedAndBreakfast]
  SchemaBedAndBreakfast({
    this.amenityFeature,
    this.audience,
  ...
  /// Serialize [SchemaBedAndBreakfast] to JSON-LD
  @override
