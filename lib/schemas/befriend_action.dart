...
class SchemaBefriendAction implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaBefriendAction]
  SchemaBefriendAction({
    this.actionStatus,
    this.agent,
    this.endTime,
    this.error,
  ...
  /// Serialize [SchemaBefriendAction] to JSON-LD
  @override
