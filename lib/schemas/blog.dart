...
/// //en.wikipedia.org/wiki/Blog), sometimes known as a "weblog". Note that
/// the individual posts ([SchemaBlogPosting]s) in a [SchemaBlog] are often
...
class SchemaBlog implements SchemaSerializable {
  ...
  /// Indicates a post that is part of a [SchemaBlog]. Note that historically,
  /// what we term a "Blog" was once known as a "weblog", and that what we term
  /// a "BlogPosting" is now often colloquially referred to as a "blog".
  ...
  /// Create a new instance of [SchemaBlog]
  SchemaBlog({
    this.blogPost,
    this.blogPosts,
    this.issn,
