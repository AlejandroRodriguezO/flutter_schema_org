...
class SchemaBoatReservation implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaBoatReservation]
  SchemaBoatReservation({
    this.bookingAgent,
    this.bookingTime,
    this.broker,
    this.modifiedTime,
  ...
  /// Serialize [SchemaBoatReservation] to JSON-LD
  @override
