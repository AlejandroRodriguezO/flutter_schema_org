...
class SchemaBookmarkAction implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaBookmarkAction]
  SchemaBookmarkAction({
    this.actionStatus,
    this.agent,
    this.endTime,
    this.error,
  ...
  /// Serialize [SchemaBookmarkAction] to JSON-LD
  @override
