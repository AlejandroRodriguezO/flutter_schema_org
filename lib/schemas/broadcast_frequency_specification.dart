...
class SchemaBroadcastFrequencySpecification implements SchemaSerializable {
  ...
  dynamic broadcastSignalModulation;
  ...
  /// Create a new instance of [SchemaBroadcastFrequencySpecification]
  SchemaBroadcastFrequencySpecification({
    this.broadcastFrequencyValue,
    this.broadcastSignalModulation,
    this.broadcastSubChannel,
    this.additionalType,
    this.alternateName,
    this.description,
  ...
  Map<String, dynamic> toJsonLd() => removeEmpty({
        ...
        'broadcastFrequencyValue': convertToJsonLd(
            broadcastFrequencyValue, [SchemaQuantitativeValue, int]),
        'broadcastSignalModulation': convertToJsonLd(
            broadcastSignalModulation, [SchemaQualitativeValue, String]),
        'broadcastSubChannel': convertToJsonLd(broadcastSubChannel, [String]),
