...
class SchemaBuddhistTemple implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaBuddhistTemple]
  SchemaBuddhistTemple({
    this.openingHours,
  ...
  /// Serialize [SchemaBuddhistTemple] to JSON-LD
  @override
