...
class SchemaBusReservation implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaBusReservation]
  SchemaBusReservation({
    this.bookingAgent,
    this.bookingTime,
    this.broker,
    this.modifiedTime,
  ...
  /// Serialize [SchemaBusReservation] to JSON-LD
  @override
