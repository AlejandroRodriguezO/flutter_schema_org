...
import 'package:flutter_schema_org/schemas/menu.dart';
...
class SchemaCafeOrCoffeeShop implements SchemaSerializable {
  ...
  /// of the menu.
  ///
  /// Supported types: [SchemaMenu], [String], [String]
  dynamic hasMenu;
  ...
  /// Create a new instance of [SchemaCafeOrCoffeeShop]
  SchemaCafeOrCoffeeShop({
  ...
  /// Serialize [SchemaCafeOrCoffeeShop] to JSON-LD
  @override
  Map<String, dynamic> toJsonLd() => removeEmpty({
        '@context': 'https://schema.org',
        '@type': 'CafeOrCoffeeShop',
        'acceptsReservations':
            convertToJsonLd(acceptsReservations, [String, String, bool]),
        'hasMenu': convertToJsonLd(hasMenu, [SchemaMenu, String, String]),
        'menu': convertToJsonLd(menu, [SchemaMenu, String, String]),
