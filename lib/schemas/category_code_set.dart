...
class SchemaCategoryCodeSet implements SchemaSerializable {
  /// A Category code contained in this code set.
  SchemaCategoryCode? hasCategoryCode;
  ...
  /// Create a new instance of [SchemaCategoryCodeSet]
  SchemaCategoryCodeSet({
    this.hasCategoryCode,
    this.hasDefinedTerm,
    this.about,
    this.abstract,
    this.accessMode,
  ...
  /// Serialize [SchemaCategoryCodeSet] to JSON-LD
  @override
  Map<String, dynamic> toJsonLd() => removeEmpty({
        '@context': 'https://schema.org',
        '@type': 'CategoryCodeSet',
        'hasCategoryCode':
            convertToJsonLd(hasCategoryCode, [SchemaCategoryCode]),
