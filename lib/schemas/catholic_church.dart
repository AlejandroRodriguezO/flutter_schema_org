...
class SchemaCatholicChurch implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaCatholicChurch]
  SchemaCatholicChurch({
    this.openingHours,
  ...
  /// Serialize [SchemaCatholicChurch] to JSON-LD
  @override
