...
class SchemaChildrensEvent implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaChildrensEvent]
  SchemaChildrensEvent({
    this.about,
    this.actor,
  ...
  /// Serialize [SchemaChildrensEvent] to JSON-LD
  @override
