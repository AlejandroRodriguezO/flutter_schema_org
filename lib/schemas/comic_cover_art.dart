...
class SchemaComicCoverArt implements SchemaSerializable {
  ...
  /// effects, to artwork.
  SchemaPerson? letterer;

  /// The individual who draws the primary narrative artwork.
  SchemaPerson? penciler;
  ...
  /// Create a new instance of [SchemaComicCoverArt]
  SchemaComicCoverArt({
    this.artist,
    this.colorist,
    this.inker,
  ...
  Map<String, dynamic> toJsonLd() => removeEmpty({
        ...
        'artMedium': convertToJsonLd(artMedium, [String, String]),
        'artform': convertToJsonLd(artform, [String, String]),
        'artworkSurface': convertToJsonLd(artworkSurface, [String, String]),
        'depth':
