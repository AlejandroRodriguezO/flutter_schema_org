...
/// comment's content is expressed via the [Schematext] property, and its
/// topic via [Schemaabout], properties shared with all CreativeWorks.
...
class SchemaComment implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaComment]
  SchemaComment({
    this.downvoteCount,
    this.parentItem,
    this.sharedContent,
