...
import 'package:flutter_schema_org/schemas/data_feed_item.dart';
...
import 'package:flutter_schema_org/schemas/data_catalog.dart';
import 'package:flutter_schema_org/schemas/data_download.dart';
import 'package:flutter_schema_org/schemas/measurement_method_enum.dart';
import 'package:flutter_schema_org/schemas/property.dart';
import 'package:flutter_schema_org/schemas/property_value.dart';
import 'package:flutter_schema_org/schemas/statistical_variable.dart';
import 'package:flutter_schema_org/schemas/text_object.dart';
import 'package:flutter_schema_org/schemas/action.dart';

/// //tools.ietf.org/html/rfc5005), for example (and as defined for Atom),
/// when using data from a feed that represents a collection of items that
/// varies over time (e.g. "Top Twenty Records") there is no need to have
...
class SchemaCompleteDataFeed implements SchemaSerializable {
  ...
  ///
  /// Supported types: [SchemaDataFeedItem], [String], [SchemaThing]
  ...
  /// Distribution) on this point). Different distributions might include or
