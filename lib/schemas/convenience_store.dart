...
class SchemaConvenienceStore implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaConvenienceStore]
  SchemaConvenienceStore({
    this.branchOf,
  ...
  /// Serialize [SchemaConvenienceStore] to JSON-LD
  @override
