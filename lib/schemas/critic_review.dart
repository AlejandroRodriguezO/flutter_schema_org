...
/// A [SchemaCriticReview] is a more specialized form of Review written or
...
/// shows, blogs and other independent Web sites. [SchemaCriticReview]s are
/// typically more in-depth and professionally written. For simpler, casually
/// written user/visitor/viewer/customer reviews, it is more appropriate to
/// use the [SchemaUserReview] type. Review aggregator sites such as
/// Metacritic already separate out the site's user reviews from selected
...
class SchemaCriticReview implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaCriticReview]
  SchemaCriticReview({
