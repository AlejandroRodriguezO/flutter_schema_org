...
class SchemaDefenceEstablishment implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaDefenceEstablishment]
  SchemaDefenceEstablishment({
    this.openingHours,
  ...
  /// Serialize [SchemaDefenceEstablishment] to JSON-LD
  @override
