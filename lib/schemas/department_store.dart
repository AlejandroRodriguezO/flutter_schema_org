...
class SchemaDepartmentStore implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaDepartmentStore]
  SchemaDepartmentStore({
    this.branchOf,
  ...
  /// Serialize [SchemaDepartmentStore] to JSON-LD
  @override
