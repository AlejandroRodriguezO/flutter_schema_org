...
class SchemaDiscoverAction implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaDiscoverAction]
  SchemaDiscoverAction({
    this.actionStatus,
    this.agent,
    this.endTime,
    this.error,
  ...
  /// Serialize [SchemaDiscoverAction] to JSON-LD
  @override
