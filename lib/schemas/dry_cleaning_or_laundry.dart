...
class SchemaDryCleaningOrLaundry implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaDryCleaningOrLaundry]
  SchemaDryCleaningOrLaundry({
    this.branchOf,
  ...
  /// Serialize [SchemaDryCleaningOrLaundry] to JSON-LD
  @override
