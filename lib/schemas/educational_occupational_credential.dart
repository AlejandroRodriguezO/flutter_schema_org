...
class SchemaEducationalOccupationalCredential implements SchemaSerializable {
  ...
  SchemaOrganization? recognizedBy;
  ...
  /// Create a new instance of [SchemaEducationalOccupationalCredential]
  SchemaEducationalOccupationalCredential({
    this.competencyRequired,
    this.credentialCategory,
  ...
  Map<String, dynamic> toJsonLd() => removeEmpty({
        ...
        'credentialCategory': convertToJsonLd(
            credentialCategory, [SchemaDefinedTerm, String, String]),
        'educationalLevel': convertToJsonLd(
            educationalLevel, [SchemaDefinedTerm, String, String]),
        'recognizedBy': convertToJsonLd(recognizedBy, [SchemaOrganization]),
