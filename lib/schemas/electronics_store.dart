...
class SchemaElectronicsStore implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaElectronicsStore]
  SchemaElectronicsStore({
    this.branchOf,
  ...
  /// Serialize [SchemaElectronicsStore] to JSON-LD
  @override
