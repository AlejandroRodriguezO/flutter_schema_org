...
class SchemaElementarySchool implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaElementarySchool]
  SchemaElementarySchool({
    this.alumni,
    this.openingHours,
  ...
  /// Serialize [SchemaElementarySchool] to JSON-LD
  @override
