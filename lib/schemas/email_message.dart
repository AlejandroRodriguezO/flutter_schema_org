...
class SchemaEmailMessage implements SchemaSerializable {
  /// A sub property of recipient. The recipient blind copied on a message.
  ///
  /// Supported types: [SchemaContactPoint], [SchemaOrganization],
  /// [SchemaPerson]
  ...
  SchemaCreativeWork? messageAttachment;

  /// A sub property of participant. The participant who is at the receiving
  /// end of the action.
  ///
  /// Supported types: [SchemaAudience], [SchemaContactPoint],
  ...
  /// of the action.
  ///
  /// Supported types: [SchemaAudience], [SchemaOrganization], [SchemaPerson]
  dynamic sender;
  ...
  /// Create a new instance of [SchemaEmailMessage]
  SchemaEmailMessage({
    this.bccRecipient,
    this.ccRecipient,
    this.dateRead,
  ...
  /// Serialize [SchemaEmailMessage] to JSON-LD
  @override
  Map<String, dynamic> toJsonLd() => removeEmpty({
        ...
        'ccRecipient': convertToJsonLd(ccRecipient,
            [SchemaContactPoint, SchemaOrganization, SchemaPerson]),
        'dateRead': convertToJsonLd(dateRead, [String, String]),
