...
class SchemaEmergencyService implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaEmergencyService]
  SchemaEmergencyService({
    this.branchOf,
  ...
  /// Serialize [SchemaEmergencyService] to JSON-LD
  @override
