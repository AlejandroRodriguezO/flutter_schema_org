...
class SchemaEmploymentAgency implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaEmploymentAgency]
  SchemaEmploymentAgency({
    this.branchOf,
  ...
  /// Serialize [SchemaEmploymentAgency] to JSON-LD
  @override
