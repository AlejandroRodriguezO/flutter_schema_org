...
class SchemaEntertainmentBusiness implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaEntertainmentBusiness]
  SchemaEntertainmentBusiness({
    this.branchOf,
  ...
  /// Serialize [SchemaEntertainmentBusiness] to JSON-LD
  @override
