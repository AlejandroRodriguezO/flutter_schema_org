...
class SchemaExchangeRateSpecification implements SchemaSerializable {
  ...
  SchemaUnitPriceSpecification? currentExchangeRate;
  ...
  /// Create a new instance of [SchemaExchangeRateSpecification]
  SchemaExchangeRateSpecification({
    this.currency,
  ...
  Map<String, dynamic> toJsonLd() => removeEmpty({
        ...
        'exchangeRateSpread':
            convertToJsonLd(exchangeRateSpread, [SchemaMonetaryAmount, int]),
