...
import 'package:flutter_schema_org/schemas/energy.dart';
...
import 'package:flutter_schema_org/schemas/anatomical_structure.dart';
import 'package:flutter_schema_org/schemas/anatomical_system.dart';
import 'package:flutter_schema_org/schemas/superficial_anatomy.dart';
...
class SchemaExercisePlan implements SchemaSerializable {
  ...
  ///
  /// Supported types: [SchemaEnergy], [SchemaQuantitativeValue]
  dynamic workload;
  ...
  /// Create a new instance of [SchemaExercisePlan]
  SchemaExercisePlan({
  ...
  Map<String, dynamic> toJsonLd() => removeEmpty({
        ...
        'repetitions':
            convertToJsonLd(repetitions, [SchemaQuantitativeValue, int]),
        'restPeriods':
