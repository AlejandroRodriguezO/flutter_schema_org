...
/// //en.wikipedia.org/wiki/FAQ)" (see also [SchemaQAPage]).
/// See https://schema.org/FAQPage
class SchemaFAQPage implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaFAQPage]
  SchemaFAQPage({
    this.breadcrumb,
    this.lastReviewed,
  ...
  /// Serialize [SchemaFAQPage] to JSON-LD
  @override
