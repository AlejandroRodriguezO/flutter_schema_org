...
class SchemaFinancialService implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaFinancialService]
  SchemaFinancialService({
  ...
  /// Serialize [SchemaFinancialService] to JSON-LD
  @override
