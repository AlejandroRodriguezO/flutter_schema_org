...
class SchemaFollowAction implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaFollowAction]
  SchemaFollowAction({
    this.followee,
    this.actionStatus,
    this.agent,
  ...
  /// Serialize [SchemaFollowAction] to JSON-LD
  @override
  Map<String, dynamic> toJsonLd() => removeEmpty({
        '@context': 'https://schema.org',
        '@type': 'FollowAction',
        'followee':
            convertToJsonLd(followee, [SchemaOrganization, SchemaPerson]),
