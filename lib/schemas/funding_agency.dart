...
/// [SchemaFundingScheme]s and manages the granting process (via
/// [SchemaGrant]s, typically [SchemaMonetaryGrant]s). A funding agency is
/// not always required for grant funding, e.g. philanthropic giving,
/// corporate sponsorship etc. Examples of funding agencies include ERC, REA,
...
class SchemaFundingAgency implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaFundingAgency]
  SchemaFundingAgency({
