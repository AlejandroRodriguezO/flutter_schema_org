...
class SchemaFurnitureStore implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaFurnitureStore]
  SchemaFurnitureStore({
    this.branchOf,
  ...
  /// Serialize [SchemaFurnitureStore] to JSON-LD
  @override
