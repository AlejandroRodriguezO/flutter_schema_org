...
import 'package:flutter_schema_org/schemas/video_game.dart';
import 'package:flutter_schema_org/schemas/game_server_status.dart';
...
class SchemaGameServer implements SchemaSerializable {
  ...
  SchemaGameServerStatus? serverStatus;
  ...
  /// Create a new instance of [SchemaGameServer]
  SchemaGameServer({
    this.game,
    this.playersOnline,
    this.serverStatus,
