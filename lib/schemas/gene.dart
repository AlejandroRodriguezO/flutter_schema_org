...
import 'package:flutter_schema_org/schemas/bio_chem_entity.dart';
...
import 'package:flutter_schema_org/schemas/taxon.dart';
...
/// //en.wikipedia.org/wiki/Gene)). Examples include FOXP2 (Forkhead box
/// protein P2), SCARNA21 (small Cajal body-specific RNA 21), A- (agouti
/// genotype).
...
class SchemaGene implements SchemaSerializable {
  ...
  SchemaBioChemEntity? encodesBioChemEntity;
  ...
  /// [SchemaBioChemEntity], [SchemaDefinedTerm]
  dynamic expressedIn;
