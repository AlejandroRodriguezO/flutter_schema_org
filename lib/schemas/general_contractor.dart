...
class SchemaGeneralContractor implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaGeneralContractor]
  SchemaGeneralContractor({
    this.branchOf,
  ...
  /// Serialize [SchemaGeneralContractor] to JSON-LD
  @override
