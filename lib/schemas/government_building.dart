...
class SchemaGovernmentBuilding implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaGovernmentBuilding]
  SchemaGovernmentBuilding({
    this.openingHours,
  ...
  /// Serialize [SchemaGovernmentBuilding] to JSON-LD
  @override
