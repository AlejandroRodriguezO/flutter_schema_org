...
class SchemaGovernmentOffice implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaGovernmentOffice]
  SchemaGovernmentOffice({
    this.branchOf,
  ...
  /// Serialize [SchemaGovernmentOffice] to JSON-LD
  @override
