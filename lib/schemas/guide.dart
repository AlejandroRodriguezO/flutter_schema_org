...
/// [SchemaGuide] is a page or article that recommends specific products or
/// services, or aspects of a thing for a user to consider. A [SchemaGuide]
/// may represent a Buying Guide and detail aspects of products or services
/// for a user to consider. A [SchemaGuide] may represent a Product Guide and
/// recommend specific products or services. A [SchemaGuide] may represent a
...
class SchemaGuide implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaGuide]
  SchemaGuide({
    this.reviewAspect,
    this.about,
    this.abstract,
