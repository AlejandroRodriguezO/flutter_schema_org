...
class SchemaHealthAndBeautyBusiness implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaHealthAndBeautyBusiness]
  SchemaHealthAndBeautyBusiness({
    this.branchOf,
  ...
  /// Serialize [SchemaHealthAndBeautyBusiness] to JSON-LD
  @override
