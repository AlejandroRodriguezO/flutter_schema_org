...
import 'package:flutter_schema_org/schemas/health_aspect_enumeration.dart';
...
/// [SchemaHealthTopicContent] is [SchemaWebContent] that is about some
...
/// different types of media. Multiple instances of [SchemaWebContent] (and
/// hence [SchemaHealthTopicContent]) can be related using [SchemahasPart] /
/// [SchemaisPartOf] where there is some kind of content hierarchy, and their
/// content described with [Schemaabout] and [Schemamentions] e.g. building
/// upon the existing [SchemaMedicalCondition] vocabulary.
...
class SchemaHealthTopicContent implements SchemaSerializable {
  ...
  /// [SchemaHealthTopicContent]. For example, that the content is an overview,
  /// or that it talks about treatment, self-care, treatments or their
  /// side-effects.
  SchemaHealthAspectEnumeration? hasHealthAspect;
  ...
  /// Create a new instance of [SchemaHealthTopicContent]
  SchemaHealthTopicContent({
  ...
  Map<String, dynamic> toJsonLd() => removeEmpty({
        ...
        'hasHealthAspect':
            convertToJsonLd(hasHealthAspect, [SchemaHealthAspectEnumeration]),
