...
/// [SchemaLocalBusiness] that provides services around homes and
/// buildings.\n\nAs a [SchemaLocalBusiness] it can be described as a
/// [Schemaprovider] of one or more [SchemaService]\(s).
/// See https://schema.org/HomeAndConstructionBusiness
class SchemaHomeAndConstructionBusiness implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaHomeAndConstructionBusiness]
  SchemaHomeAndConstructionBusiness({
    this.branchOf,
  ...
  /// Serialize [SchemaHomeAndConstructionBusiness] to JSON-LD
  @override
