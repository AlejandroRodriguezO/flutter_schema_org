...
class SchemaHomeGoodsStore implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaHomeGoodsStore]
  SchemaHomeGoodsStore({
    this.branchOf,
  ...
  /// Serialize [SchemaHomeGoodsStore] to JSON-LD
  @override
