...
import 'package:flutter_schema_org/schemas/cdcpmd_record.dart';
...
class SchemaHospital implements SchemaSerializable {
  ...
  /// Indicates data describing a hospital, e.g. a CDC [SchemaCDCPMDRecord] or
  /// as some kind of [SchemaDataset].
  ///
  /// Supported types: [SchemaCDCPMDRecord], [SchemaDataset]
  dynamic healthcareReportingData;
  ...
  /// Create a new instance of [SchemaHospital]
  SchemaHospital({
  ...
  Map<String, dynamic> toJsonLd() => removeEmpty({
        ...
        'healthcareReportingData': convertToJsonLd(
            healthcareReportingData, [SchemaCDCPMDRecord, SchemaDataset]),
        'medicalSpecialty':
