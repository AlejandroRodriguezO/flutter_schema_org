...
/// //en.wikipedia.org/wiki/Hotel). <br /><br /> See also the <a
...
class SchemaHotel implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaHotel]
  SchemaHotel({
    this.amenityFeature,
    this.audience,
  ...
  /// Serialize [SchemaHotel] to JSON-LD
  @override
