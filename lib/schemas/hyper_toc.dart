...
/// objects, such as [SchemaVideoObject], [SchemaAudioObject]. Items in the
/// table of contents are indicated using the [SchematocEntry] property, and
/// typed [SchemaHyperTocEntry]. For cases where the same larger work is
/// split into multiple files, [SchemaassociatedMedia] can be used on
/// individual [SchemaHyperTocEntry] items.
...
class SchemaHyperToc implements SchemaSerializable {
  ...
  /// Indicates a [SchemaHyperTocEntry] in a [SchemaHyperToc].
  SchemaHyperTocEntry? tocEntry;
  ...
  /// Create a new instance of [SchemaHyperToc]
  SchemaHyperToc({
  ...
  Map<String, dynamic> toJsonLd() => removeEmpty({
        ...
        'tocEntry': convertToJsonLd(tocEntry, [SchemaHyperTocEntry]),
