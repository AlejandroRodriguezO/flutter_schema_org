...
/// A specific and exact (byte-for-byte) version of an [SchemaImageObject].
/// Two byte-for-byte identical files, for the purposes of this type,
/// considered identical. If they have different embedded metadata (e.g. XMP,
/// EXIF) the files will differ. Different external facts about the files,
/// e.g. creator or dateCreated that aren't represented in their actual
...
class SchemaImageObjectSnapshot implements SchemaSerializable {
  ...
  /// [SchemaencodingFormat].
  ///
  /// Supported types: [SchemaMediaObject], [String]
  dynamic caption;

  /// Represents textual captioning from a [SchemaMediaObject], e.g. text of a
  /// 'meme'.
  String? embeddedTextCaption;

  /// exif data for this object.
  ///
  /// Supported types: [SchemaPropertyValue], [String]
  dynamic exifData;

  /// Indicates whether this image is representative of the content of the
  /// page.
  bool? representativeOfPage;
  ...
  /// Create a new instance of [SchemaImageObjectSnapshot]
  SchemaImageObjectSnapshot({
    this.caption,
    this.embeddedTextCaption,
    this.exifData,
