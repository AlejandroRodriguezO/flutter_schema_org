...
import 'package:flutter_schema_org/schemas/medical_organization.dart';
import 'package:flutter_schema_org/schemas/medical_procedure.dart';
import 'package:flutter_schema_org/schemas/medical_test.dart';
import 'package:flutter_schema_org/schemas/medical_therapy.dart';
import 'package:flutter_schema_org/schemas/hospital.dart';
...
import 'package:flutter_schema_org/schemas/geo_shape.dart';
import 'package:flutter_schema_org/schemas/place.dart';
import 'package:flutter_schema_org/schemas/brand.dart';
import 'package:flutter_schema_org/schemas/contact_point.dart';
import 'package:flutter_schema_org/schemas/article.dart';
import 'package:flutter_schema_org/schemas/event.dart';
import 'package:flutter_schema_org/schemas/grant.dart';
import 'package:flutter_schema_org/schemas/certification.dart';
import 'package:flutter_schema_org/schemas/educational_occupational_credential.dart';
import 'package:flutter_schema_org/schemas/merchant_return_policy.dart';
import 'package:flutter_schema_org/schemas/offer_catalog.dart';
...
import 'package:flutter_schema_org/schemas/virtual_location.dart';
import 'package:flutter_schema_org/schemas/image_object.dart';
import 'package:flutter_schema_org/schemas/offer.dart';
import 'package:flutter_schema_org/schemas/program_membership.dart';
import 'package:flutter_schema_org/schemas/nonprofit_type.dart';
import 'package:flutter_schema_org/schemas/quantitative_value.dart';
import 'package:flutter_schema_org/schemas/about_page.dart';
import 'package:flutter_schema_org/schemas/ownership_info.dart';
...
import 'package:flutter_schema_org/schemas/location_feature_specification.dart';
import 'package:flutter_schema_org/schemas/geo_coordinates.dart';
import 'package:flutter_schema_org/schemas/geospatial_geometry.dart';
import 'package:flutter_schema_org/schemas/map.dart';
import 'package:flutter_schema_org/schemas/opening_hours_specification.dart';
import 'package:flutter_schema_org/schemas/photograph.dart';
...
/// [Schemaaddress], for affiliations to hospitals use
/// [SchemahospitalAffiliation]. The [SchemapracticesAt] property can be used
/// to indicate [SchemaMedicalOrganization] hospitals, clinics, pharmacies
/// etc. where this physician practices.
/// See https://schema.org/IndividualPhysician
class SchemaIndividualPhysician implements SchemaSerializable {
  /// A [SchemaMedicalOrganization] where the [SchemaIndividualPhysician]
  /// practices.
  SchemaMedicalOrganization? practicesAt;

  /// A medical service available from this provider.
  ///
  /// Supported types: [SchemaMedicalProcedure], [SchemaMedicalTest],
  /// [SchemaMedicalTherapy]
  dynamic availableService;

  /// A hospital with which the physician or office is affiliated.
  SchemaHospital? hospitalAffiliation;

  /// A medical specialty of the provider.
  SchemaMedicalSpecialty? medicalSpecialty;
  ...
  /// //en.wikipedia.org/wiki/National_Provider_Identifier">National Provider
  /// Identifier</a> (NPI) is a unique 10-digit identification number issued to
  /// health care providers in the United States by the Centers for Medicare
  ...
  /// Create a new instance of [SchemaIndividualPhysician]
  SchemaIndividualPhysician({
    this.practicesAt,
  ...
  Map<String, dynamic> toJsonLd() => removeEmpty({
        ...
        'practicesAt':
            convertToJsonLd(practicesAt, [SchemaMedicalOrganization]),
        'availableService': convertToJsonLd(availableService,
            [SchemaMedicalProcedure, SchemaMedicalTest, SchemaMedicalTherapy]),
        'hospitalAffiliation':
            convertToJsonLd(hospitalAffiliation, [SchemaHospital]),
        'medicalSpecialty':
            convertToJsonLd(medicalSpecialty, [SchemaMedicalSpecialty]),
        'occupationalCategory':
            convertToJsonLd(occupationalCategory, [SchemaCategoryCode, String]),
        'usNPI': convertToJsonLd(usNPI, [String]),
        ...
        'isAcceptingNewPatients':
            convertToJsonLd(isAcceptingNewPatients, [bool]),
