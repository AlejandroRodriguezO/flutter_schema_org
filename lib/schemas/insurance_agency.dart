...
class SchemaInsuranceAgency implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaInsuranceAgency]
  SchemaInsuranceAgency({
  ...
  /// Serialize [SchemaInsuranceAgency] to JSON-LD
  @override
