...
class SchemaLakeBodyOfWater implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaLakeBodyOfWater]
  SchemaLakeBodyOfWater({
  ...
  /// Serialize [SchemaLakeBodyOfWater] to JSON-LD
  @override
