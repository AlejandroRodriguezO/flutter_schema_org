...
class SchemaLandmarksOrHistoricalBuildings implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaLandmarksOrHistoricalBuildings]
  SchemaLandmarksOrHistoricalBuildings({
  ...
  /// Serialize [SchemaLandmarksOrHistoricalBuildings] to JSON-LD
  @override
