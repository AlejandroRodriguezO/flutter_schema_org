...
/// The LearningResource type can be used to indicate [SchemaCreativeWork]s
...
///
/// [SchemaLearningResource] is expected to be used as an addition to a
/// primary type such as [SchemaBook], [SchemaVideoObject], [SchemaProduct]
/// etc.
///
/// [SchemaEducationEvent] serves a similar purpose for event-like things
/// (e.g. a [SchemaTrip]). A [SchemaLearningResource] may be created as a
/// result of an [SchemaEducationEvent], for example by recording one.
...
class SchemaLearningResource implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaLearningResource]
