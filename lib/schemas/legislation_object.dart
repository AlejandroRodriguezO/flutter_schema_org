...
import 'package:flutter_schema_org/schemas/legal_value_level.dart';
import 'package:flutter_schema_org/schemas/administrative_area.dart';
import 'package:flutter_schema_org/schemas/legislation.dart';
import 'package:flutter_schema_org/schemas/legal_force_status.dart';
...
import 'package:flutter_schema_org/schemas/media_subscription.dart';
...
class SchemaLegislationObject implements SchemaSerializable {
  ...
  /// implemented in it.
  SchemaLegislation? legislationApplies;
  ...
  SchemaLegislation? legislationChanges;
  ...
  SchemaLegislation? legislationConsolidates;
  ...
  String? legislationDate;

  /// when looking at the law on the 2016-04-07 (= dateVersion), I get the
  /// consolidation of 2015-04-12 of the "National Insurance Contributions Act
  /// 2015")
  String? legislationDateVersion;
  ...
  ///
  /// Supported types: [SchemaAdministrativeArea], [String]
  dynamic legislationJurisdiction;

  /// Whether the legislation is currently in force, not in force, or partially
  /// in force.
  SchemaLegalForceStatus? legislationLegalForce;
  ...
  ///
  /// Supported types: [SchemaOrganization], [SchemaPerson]
  dynamic legislationResponsible;
  ...
  SchemaLegislation? legislationTransposes;
  ...
  /// Create a new instance of [SchemaLegislationObject]
  SchemaLegislationObject({
    this.legislationLegalValue,
    this.jurisdiction,
    this.legislationApplies,
    this.legislationChanges,
    this.legislationConsolidates,
    this.legislationDate,
    this.legislationDateVersion,
    this.legislationIdentifier,
    this.legislationJurisdiction,
    this.legislationLegalForce,
    this.legislationPassedBy,
    this.legislationResponsible,
    this.legislationTransposes,
  ...
  Map<String, dynamic> toJsonLd() => removeEmpty({
        ...
        'legislationIdentifier':
            convertToJsonLd(legislationIdentifier, [String, String]),
