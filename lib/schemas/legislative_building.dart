...
class SchemaLegislativeBuilding implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaLegislativeBuilding]
  SchemaLegislativeBuilding({
    this.openingHours,
  ...
  /// Serialize [SchemaLegislativeBuilding] to JSON-LD
  @override
