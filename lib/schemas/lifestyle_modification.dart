...
class SchemaLifestyleModification implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaLifestyleModification]
  ...
  /// Serialize [SchemaLifestyleModification] to JSON-LD
  @override
