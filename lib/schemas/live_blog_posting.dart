...
import 'package:flutter_schema_org/schemas/blog_posting.dart';
...
/// A [SchemaLiveBlogPosting] is a [SchemaBlogPosting] intended to provide a
/// rolling textual coverage of an ongoing event through continuous updates.
...
class SchemaLiveBlogPosting implements SchemaSerializable {
  ...
  SchemaBlogPosting? liveBlogUpdate;
  ...
  /// Create a new instance of [SchemaLiveBlogPosting]
  SchemaLiveBlogPosting({
  ...
  Map<String, dynamic> toJsonLd() => removeEmpty({
        ...
        'coverageStartTime': convertToJsonLd(coverageStartTime, [String]),
        'liveBlogUpdate': convertToJsonLd(liveBlogUpdate, [SchemaBlogPosting]),
