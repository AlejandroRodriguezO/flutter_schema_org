...
import 'package:flutter_schema_org/schemas/solve_math_action.dart';
...
class SchemaMathSolver implements SchemaSerializable {
  ...
  /// keyboard.
  ///
  /// Supported types: [SchemaSolveMathAction], [String]
  ...
  /// Create a new instance of [SchemaMathSolver]
  SchemaMathSolver({
    this.mathExpression,
    this.about,
    this.abstract,
  ...
  Map<String, dynamic> toJsonLd() => removeEmpty({
        ...
        '@type': 'MathSolver',
        'mathExpression':
            convertToJsonLd(mathExpression, [SchemaSolveMathAction, String]),
