...
class SchemaMaximumDoseSchedule implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaMaximumDoseSchedule]
  SchemaMaximumDoseSchedule({
    this.doseUnit,
    this.doseValue,
    this.frequency,
  ...
  /// Serialize [SchemaMaximumDoseSchedule] to JSON-LD
  @override
