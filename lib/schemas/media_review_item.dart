...
/// for the sake of evaluation in a [SchemaMediaReview]. Authorship etc.
/// apply to the items rather than to the curation/grouping or reviewing
/// party.
/// See https://schema.org/MediaReviewItem
class SchemaMediaReviewItem implements SchemaSerializable {
  /// In the context of a [SchemaMediaReview], indicates specific media item(s)
  /// that are grouped using a [SchemaMediaReviewItem].
  ...
  /// Create a new instance of [SchemaMediaReviewItem]
  SchemaMediaReviewItem({
    this.mediaItemAppearance,
    this.about,
    this.abstract,
    this.accessMode,
  ...
  Map<String, dynamic> toJsonLd() => removeEmpty({
        ...
        'mediaItemAppearance':
            convertToJsonLd(mediaItemAppearance, [SchemaMediaObject]),
