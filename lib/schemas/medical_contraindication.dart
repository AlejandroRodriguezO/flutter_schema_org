...
class SchemaMedicalContraindication implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaMedicalContraindication]
  SchemaMedicalContraindication({
    this.code,
    this.funding,
    this.guideline,
    this.legalStatus,
  ...
  /// Serialize [SchemaMedicalContraindication] to JSON-LD
  @override
