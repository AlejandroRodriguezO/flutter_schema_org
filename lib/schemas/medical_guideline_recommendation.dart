...
import 'package:flutter_schema_org/schemas/medical_evidence_level.dart';
...
class SchemaMedicalGuidelineRecommendation implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaMedicalGuidelineRecommendation]
  SchemaMedicalGuidelineRecommendation({
    this.recommendationStrength,
    this.evidenceLevel,
    this.evidenceOrigin,
    this.guidelineDate,
  ...
  /// Serialize [SchemaMedicalGuidelineRecommendation] to JSON-LD
  @override
  Map<String, dynamic> toJsonLd() => removeEmpty({
        '@context': 'https://schema.org',
        '@type': 'MedicalGuidelineRecommendation',
        'recommendationStrength':
            convertToJsonLd(recommendationStrength, [String]),
        'evidenceLevel':
