...
class SchemaMedicalIntangible implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaMedicalIntangible]
  SchemaMedicalIntangible({
    this.code,
    this.funding,
    this.guideline,
    this.legalStatus,
  ...
  /// Serialize [SchemaMedicalIntangible] to JSON-LD
  @override
