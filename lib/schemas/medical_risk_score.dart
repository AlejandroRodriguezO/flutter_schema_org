...
class SchemaMedicalRiskScore implements SchemaSerializable {
  /// The algorithm or rules to follow to compute the score.
  String? algorithm;

  /// The condition, complication, or symptom whose risk is being estimated.
  SchemaMedicalEntity? estimatesRiskOf;

  /// A modifiable or non-modifiable risk factor included in the calculation,
  /// e.g. age, coexisting condition.
  SchemaMedicalRiskFactor? includedRiskFactor;
  ...
  /// Create a new instance of [SchemaMedicalRiskScore]
  SchemaMedicalRiskScore({
    this.algorithm,
  ...
  /// Serialize [SchemaMedicalRiskScore] to JSON-LD
  @override
  Map<String, dynamic> toJsonLd() => removeEmpty({
        '@context': 'https://schema.org',
        '@type': 'MedicalRiskScore',
        'algorithm': convertToJsonLd(algorithm, [String]),
        'estimatesRiskOf':
            convertToJsonLd(estimatesRiskOf, [SchemaMedicalEntity]),
        'includedRiskFactor':
            convertToJsonLd(includedRiskFactor, [SchemaMedicalRiskFactor]),
