...
import 'package:flutter_schema_org/schemas/medical_audience.dart';
import 'package:flutter_schema_org/schemas/medical_audience_type.dart';
...
class SchemaMedicalWebPage implements SchemaSerializable {
  ...
  ///
  /// Supported types: [SchemaMedicalAudience], [SchemaMedicalAudienceType]
  dynamic medicalAudience;
  ...
  /// Create a new instance of [SchemaMedicalWebPage]
  SchemaMedicalWebPage({
    this.aspect,
    this.medicalAudience,
    this.breadcrumb,
    this.lastReviewed,
  ...
  Map<String, dynamic> toJsonLd() => removeEmpty({
        ...
        'medicalAudience': convertToJsonLd(medicalAudience,
            [SchemaMedicalAudience, SchemaMedicalAudienceType]),
        'breadcrumb':
