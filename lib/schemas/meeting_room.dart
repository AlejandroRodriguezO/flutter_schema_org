...
import 'package:flutter_schema_org/schemas/floor_plan.dart';
import 'package:flutter_schema_org/schemas/location_feature_specification.dart';
import 'package:flutter_schema_org/schemas/bed_details.dart';
import 'package:flutter_schema_org/schemas/bed_type.dart';
...
/// //en.wikipedia.org/wiki/Conference_hall</a>). <br /><br /> See also the
/// <a href="/docs/hotels.html">dedicated document on the use of schema.org
/// for marking up hotels and other forms of accommodations</a>.
/// See https://schema.org/MeetingRoom
class SchemaMeetingRoom implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaMeetingRoom]
  SchemaMeetingRoom({
  ...
  /// Serialize [SchemaMeetingRoom] to JSON-LD
  @override
