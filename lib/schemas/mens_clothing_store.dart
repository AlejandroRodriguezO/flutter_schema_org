...
class SchemaMensClothingStore implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaMensClothingStore]
  SchemaMensClothingStore({
    this.branchOf,
  ...
  /// Serialize [SchemaMensClothingStore] to JSON-LD
  @override
