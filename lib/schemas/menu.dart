...
import 'package:flutter_schema_org/schemas/menu_item.dart';
import 'package:flutter_schema_org/schemas/menu_section.dart';
...
class SchemaMenu implements SchemaSerializable {
  ...
  SchemaMenuSection? hasMenuSection;
  ...
  /// Create a new instance of [SchemaMenu]
  SchemaMenu({
    this.hasMenuItem,
    this.hasMenuSection,
    this.about,
  ...
  Map<String, dynamic> toJsonLd() => removeEmpty({
        ...
        'hasMenuSection': convertToJsonLd(hasMenuSection, [SchemaMenuSection]),
