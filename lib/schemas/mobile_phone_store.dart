...
class SchemaMobilePhoneStore implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaMobilePhoneStore]
  SchemaMobilePhoneStore({
    this.branchOf,
  ...
  /// Serialize [SchemaMobilePhoneStore] to JSON-LD
  @override
