...
import 'package:flutter_schema_org/schemas/bank_or_credit_union.dart';
...
class SchemaMoneyTransfer implements SchemaSerializable {
  ...
  /// for the beneficiary.
  ///
  /// Supported types: [SchemaBankOrCreditUnion], [String]
  dynamic beneficiaryBank;
  ...
  Map<String, dynamic> toJsonLd() => removeEmpty({
        ...
        'beneficiaryBank':
            convertToJsonLd(beneficiaryBank, [SchemaBankOrCreditUnion, String]),
