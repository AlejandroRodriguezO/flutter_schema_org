...
class SchemaMotorcycleDealer implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaMotorcycleDealer]
  SchemaMotorcycleDealer({
    this.branchOf,
  ...
  /// Serialize [SchemaMotorcycleDealer] to JSON-LD
  @override
