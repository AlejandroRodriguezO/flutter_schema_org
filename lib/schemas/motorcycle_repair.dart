...
class SchemaMotorcycleRepair implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaMotorcycleRepair]
  SchemaMotorcycleRepair({
    this.branchOf,
  ...
  /// Serialize [SchemaMotorcycleRepair] to JSON-LD
  @override
