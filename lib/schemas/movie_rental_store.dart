...
class SchemaMovieRentalStore implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaMovieRentalStore]
  SchemaMovieRentalStore({
    this.branchOf,
  ...
  /// Serialize [SchemaMovieRentalStore] to JSON-LD
  @override
