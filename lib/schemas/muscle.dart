...
import 'package:flutter_schema_org/schemas/vessel.dart';
import 'package:flutter_schema_org/schemas/anatomical_structure.dart';
import 'package:flutter_schema_org/schemas/nerve.dart';
...
class SchemaMuscle implements SchemaSerializable {
  ...
  SchemaVessel? bloodSupply;

  /// The place of attachment of a muscle, or what the muscle moves.
  SchemaAnatomicalStructure? insertion;
  ...
  Map<String, dynamic> toJsonLd() => removeEmpty({
        ...
        'bloodSupply': convertToJsonLd(bloodSupply, [SchemaVessel]),
        'insertion': convertToJsonLd(insertion, [SchemaAnatomicalStructure]),
        'muscleAction': convertToJsonLd(muscleAction, [String]),
        'nerve': convertToJsonLd(nerve, [SchemaNerve]),
