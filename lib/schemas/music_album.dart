...
import 'package:flutter_schema_org/schemas/music_album_production_type.dart';
import 'package:flutter_schema_org/schemas/music_release.dart';
import 'package:flutter_schema_org/schemas/music_album_release_type.dart';
...
class SchemaMusicAlbum implements SchemaSerializable {
  ...
  SchemaMusicRelease? albumRelease;

  /// single, EP or album.
  SchemaMusicAlbumReleaseType? albumReleaseType;
  ...
  ///
  /// Supported types: [SchemaItemList], [SchemaMusicRecording]
  dynamic track;

  /// A music recording (track)&#x2014;usually a single song.
  SchemaMusicRecording? tracks;
  ...
  /// Create a new instance of [SchemaMusicAlbum]
  SchemaMusicAlbum({
    this.albumProductionType,
    this.albumRelease,
    this.albumReleaseType,
    this.byArtist,
    this.numTracks,
    this.track,
    this.tracks,
  ...
  Map<String, dynamic> toJsonLd() => removeEmpty({
        ...
        'track': convertToJsonLd(track, [SchemaItemList, SchemaMusicRecording]),
        'tracks': convertToJsonLd(tracks, [SchemaMusicRecording]),
