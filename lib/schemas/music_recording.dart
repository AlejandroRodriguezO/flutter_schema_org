...
import 'package:flutter_schema_org/schemas/music_playlist.dart';
import 'package:flutter_schema_org/schemas/music_composition.dart';
...
class SchemaMusicRecording implements SchemaSerializable {
  ...
  SchemaMusicAlbum? inAlbum;

  /// The playlist to which this recording belongs.
  SchemaMusicPlaylist? inPlaylist;

  /// The International Standard Recording Code for the recording.
  String? isrcCode;

  /// The composition this track is a recording of.
  SchemaMusicComposition? recordingOf;
  ...
  /// Create a new instance of [SchemaMusicRecording]
  SchemaMusicRecording({
    this.byArtist,
    this.duration,
    this.inAlbum,
