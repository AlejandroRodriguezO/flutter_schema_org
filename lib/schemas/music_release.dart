...
import 'package:flutter_schema_org/schemas/music_release_format_type.dart';
import 'package:flutter_schema_org/schemas/music_album.dart';
...
class SchemaMusicRelease implements SchemaSerializable {
  ...
  SchemaMusicReleaseFormatType? musicReleaseFormat;

  /// The label that issued the release.
  SchemaOrganization? recordLabel;

  /// The album this is a release of.
  SchemaMusicAlbum? releaseOf;
  ...
  /// Create a new instance of [SchemaMusicRelease]
  SchemaMusicRelease({
    this.catalogNumber,
    this.creditedTo,
    this.duration,
    this.musicReleaseFormat,
    this.recordLabel,
    this.releaseOf,
    this.numTracks,
    this.track,
