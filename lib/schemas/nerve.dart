...
import 'package:flutter_schema_org/schemas/muscle.dart';
import 'package:flutter_schema_org/schemas/superficial_anatomy.dart';
import 'package:flutter_schema_org/schemas/brain_structure.dart';
...
class SchemaNerve implements SchemaSerializable {
  ...
  SchemaMuscle? nerveMotor;

  /// The neurological pathway extension that inputs and sends information to
  /// the brain or spinal cord.
  ///
  /// Supported types: [SchemaAnatomicalStructure], [SchemaSuperficialAnatomy]
  dynamic sensoryUnit;

  /// The neurological pathway that originates the neurons.
  SchemaBrainStructure? sourcedFrom;
