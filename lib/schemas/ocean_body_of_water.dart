...
class SchemaOceanBodyOfWater implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaOceanBodyOfWater]
  SchemaOceanBodyOfWater({
  ...
  /// Serialize [SchemaOceanBodyOfWater] to JSON-LD
  @override
