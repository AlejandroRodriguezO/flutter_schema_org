...
class SchemaOfficeEquipmentStore implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaOfficeEquipmentStore]
  SchemaOfficeEquipmentStore({
    this.branchOf,
  ...
  /// Serialize [SchemaOfficeEquipmentStore] to JSON-LD
  @override
