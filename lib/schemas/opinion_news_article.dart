...
/// An [SchemaOpinionNewsArticle] is a [SchemaNewsArticle] that primarily
/// expresses opinions rather than journalistic reporting of news and events.
/// For example, a [SchemaNewsArticle] consisting of a column or
/// [SchemaBlog]/[SchemaBlogPosting] entry in the Opinions section of a news
/// publication.
...
class SchemaOpinionNewsArticle implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaOpinionNewsArticle]
  SchemaOpinionNewsArticle({
    this.dateline,
    this.printColumn,
    this.printEdition,
    this.printPage,
