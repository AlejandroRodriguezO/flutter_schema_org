...
class SchemaOrganizeAction implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaOrganizeAction]
  SchemaOrganizeAction({
    this.actionStatus,
    this.agent,
    this.endTime,
    this.error,
  ...
  /// Serialize [SchemaOrganizeAction] to JSON-LD
  @override
