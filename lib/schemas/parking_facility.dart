...
class SchemaParkingFacility implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaParkingFacility]
  SchemaParkingFacility({
    this.openingHours,
  ...
  /// Serialize [SchemaParkingFacility] to JSON-LD
  @override
