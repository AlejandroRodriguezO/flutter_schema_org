...
class SchemaPerformingArtsTheater implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaPerformingArtsTheater]
  SchemaPerformingArtsTheater({
    this.openingHours,
  ...
  /// Serialize [SchemaPerformingArtsTheater] to JSON-LD
  @override
