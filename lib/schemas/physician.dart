...
/// [SchemaMedicalOrganization].
/// See https://schema.org/Physician
class SchemaPhysician implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaPhysician]
  SchemaPhysician({
  ...
  /// Serialize [SchemaPhysician] to JSON-LD
  @override
