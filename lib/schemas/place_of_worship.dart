...
class SchemaPlaceOfWorship implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaPlaceOfWorship]
  SchemaPlaceOfWorship({
    this.openingHours,
  ...
  /// Serialize [SchemaPlaceOfWorship] to JSON-LD
  @override
