...
/// A performance of a Play would be a [SchemaTheaterEvent] or
/// [SchemaBroadcastEvent] - the *Play* being the [SchemaworkPerformed].
...
class SchemaPlay implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaPlay]
  SchemaPlay({
    this.about,
    this.abstract,
    this.accessMode,
