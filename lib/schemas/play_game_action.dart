...
import 'package:flutter_schema_org/schemas/game_availability_enumeration.dart';
import 'package:flutter_schema_org/schemas/action_access_specification.dart';
...
class SchemaPlayGameAction implements SchemaSerializable {
  ...
  ///
  /// Supported types: [SchemaGameAvailabilityEnumeration], [String]
  dynamic gameAvailabilityType;
  ...
  /// Create a new instance of [SchemaPlayGameAction]
  SchemaPlayGameAction({
    this.gameAvailabilityType,
  ...
  Map<String, dynamic> toJsonLd() => removeEmpty({
        ...
        'gameAvailabilityType': convertToJsonLd(
            gameAvailabilityType, [SchemaGameAvailabilityEnumeration, String]),
