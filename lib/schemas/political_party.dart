...
class SchemaPoliticalParty implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaPoliticalParty]
  SchemaPoliticalParty({
  ...
  /// Serialize [SchemaPoliticalParty] to JSON-LD
  @override
