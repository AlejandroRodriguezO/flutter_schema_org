...
class SchemaPreOrderAction implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaPreOrderAction]
  SchemaPreOrderAction({
    this.price,
    this.priceCurrency,
  ...
  /// Serialize [SchemaPreOrderAction] to JSON-LD
  @override
