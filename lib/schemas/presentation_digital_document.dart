...
import 'package:flutter_schema_org/schemas/digital_document_permission.dart';
...
class SchemaPresentationDigitalDocument implements SchemaSerializable {
  ...
  SchemaDigitalDocumentPermission? hasDigitalDocumentPermission;
  ...
  /// Create a new instance of [SchemaPresentationDigitalDocument]
  SchemaPresentationDigitalDocument({
    this.hasDigitalDocumentPermission,
    this.about,
    this.abstract,
    this.accessMode,
  ...
  /// Serialize [SchemaPresentationDigitalDocument] to JSON-LD
  @override
  Map<String, dynamic> toJsonLd() => removeEmpty({
        '@context': 'https://schema.org',
        '@type': 'PresentationDigitalDocument',
        'hasDigitalDocumentPermission': convertToJsonLd(
            hasDigitalDocumentPermission, [SchemaDigitalDocumentPermission]),
