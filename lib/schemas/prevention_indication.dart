...
class SchemaPreventionIndication implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaPreventionIndication]
  SchemaPreventionIndication({
    this.code,
    this.funding,
    this.guideline,
    this.legalStatus,
  ...
  /// Serialize [SchemaPreventionIndication] to JSON-LD
  @override
