...
class SchemaPublicSwimmingPool implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaPublicSwimmingPool]
  SchemaPublicSwimmingPool({
    this.branchOf,
  ...
  /// Serialize [SchemaPublicSwimmingPool] to JSON-LD
  @override
