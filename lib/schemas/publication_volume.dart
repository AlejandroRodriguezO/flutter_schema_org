...
class SchemaPublicationVolume implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaPublicationVolume]
  SchemaPublicationVolume({
    this.pageEnd,
    this.pageStart,
    this.pagination,
    this.volumeNumber,
  ...
  /// Serialize [SchemaPublicationVolume] to JSON-LD
  @override
  Map<String, dynamic> toJsonLd() => removeEmpty({
        ...
        'volumeNumber': convertToJsonLd(volumeNumber, [String, int]),
