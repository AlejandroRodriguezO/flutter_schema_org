...
import 'package:flutter_schema_org/schemas/answer.dart';
...
class SchemaQuestion implements SchemaSerializable {
  ...
  ///
  /// Supported types: [SchemaAnswer], [SchemaItemList]
  dynamic acceptedAnswer;
  ...
  /// Create a new instance of [SchemaQuestion]
  SchemaQuestion({
    this.acceptedAnswer,
    this.answerCount,
