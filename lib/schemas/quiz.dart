...
/// A test of knowledge, skills and abilities.
/// See https://schema.org/Quiz
class SchemaQuiz implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaQuiz]
  SchemaQuiz({
    this.assesses,
  ...
  /// Serialize [SchemaQuiz] to JSON-LD
  @override
