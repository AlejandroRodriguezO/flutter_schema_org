...
/// character - to any fictional Person. Use [SchemaisBasedOn] to link to
/// source/origin. The [SchemarecordedIn] property can be used to reference a
/// Quotation from an [SchemaEvent].
...
class SchemaQuotation implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaQuotation]
  SchemaQuotation({
    this.spokenByCharacter,
    this.about,
    this.abstract,
    this.accessMode,
  ...
  Map<String, dynamic> toJsonLd() => removeEmpty({
        ...
        'spokenByCharacter': convertToJsonLd(
            spokenByCharacter, [SchemaOrganization, SchemaPerson]),
