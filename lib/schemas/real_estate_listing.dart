...
import 'package:flutter_schema_org/schemas/breadcrumb_list.dart';
import 'package:flutter_schema_org/schemas/web_page_element.dart';
...
import 'package:flutter_schema_org/schemas/specialty.dart';
...
/// A [SchemaRealEstateListing] is a listing that describes one or more
/// real-estate [SchemaOffer]s (whose [SchemabusinessFunction] is typically
/// to lease out, or to sell). The [SchemaRealEstateListing] type itself
/// represents the overall listing, as manifested in some [SchemaWebPage].
/// See https://schema.org/RealEstateListing
class SchemaRealEstateListing implements SchemaSerializable {
  ...
  /// hierarchy.
  ///
  /// Supported types: [SchemaBreadcrumbList], [String]
  dynamic breadcrumb;
  ...
  SchemaWebPageElement? mainContentOfPage;

  /// Indicates the main image on the page.
  SchemaImageObject? primaryImageOfPage;
  ...
  /// Create a new instance of [SchemaRealEstateListing]
  ...
  /// Serialize [SchemaRealEstateListing] to JSON-LD
  @override
