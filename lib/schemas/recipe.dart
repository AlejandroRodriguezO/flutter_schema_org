...
import 'package:flutter_schema_org/schemas/nutrition_information.dart';
...
import 'package:flutter_schema_org/schemas/restricted_diet.dart';
import 'package:flutter_schema_org/schemas/monetary_amount.dart';
import 'package:flutter_schema_org/schemas/how_to_section.dart';
import 'package:flutter_schema_org/schemas/how_to_step.dart';
import 'package:flutter_schema_org/schemas/how_to_supply.dart';
import 'package:flutter_schema_org/schemas/how_to_tool.dart';
...
/// restrictions are enumerated via [SchemasuitableForDiet]. The
/// [Schemakeywords] property can also be used to add more detail.
...
class SchemaRecipe implements SchemaSerializable {
  ...
  ///
  /// Supported types: [SchemaCreativeWork], [SchemaItemList], [String]
  dynamic recipeInstructions;
  ...
  /// instructions.
  ///
  /// Supported types: [SchemaMonetaryAmount], [String]
  dynamic estimatedCost;

  /// //en.wikipedia.org/wiki/ISO_8601).
  SchemaDuration? performTime;

  /// //en.wikipedia.org/wiki/ISO_8601).
  SchemaDuration? prepTime;

  /// A single step item (as HowToStep, text, document, video, etc.) or a
  /// HowToSection.
  ///
  /// Supported types: [SchemaCreativeWork], [SchemaHowToSection],
  /// [SchemaHowToStep], [String]
  dynamic step;
  ...
  ///
  /// Supported types: [SchemaHowToSupply], [String]
  dynamic supply;

  /// A sub property of instrument. An object used (but not consumed) when
  /// performing instructions or a direction.
  ///
  /// Supported types: [SchemaHowToTool], [String]
  dynamic tool;

  /// //en.wikipedia.org/wiki/ISO_8601).
  SchemaDuration? totalTime;
  ...
  Map<String, dynamic> toJsonLd() => removeEmpty({
        ...
        'recipeIngredient': convertToJsonLd(recipeIngredient, [String]),
