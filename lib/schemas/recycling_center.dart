...
class SchemaRecyclingCenter implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaRecyclingCenter]
  SchemaRecyclingCenter({
    this.branchOf,
  ...
  /// Serialize [SchemaRecyclingCenter] to JSON-LD
  @override
