...
class SchemaReport implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaReport]
  SchemaReport({
    this.reportNumber,
    this.articleBody,
    this.articleSection,
  ...
  /// Serialize [SchemaReport] to JSON-LD
  @override
  Map<String, dynamic> toJsonLd() => removeEmpty({
        '@context': 'https://schema.org',
        '@type': 'Report',
        'reportNumber': convertToJsonLd(reportNumber, [String]),
