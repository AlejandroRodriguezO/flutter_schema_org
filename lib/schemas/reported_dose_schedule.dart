...
class SchemaReportedDoseSchedule implements SchemaSerializable {
  /// The unit of the dose, e.g. 'mg'.
  String? doseUnit;

  /// The value of the dose, e.g. 500.
  ///
  /// Supported types: [SchemaQualitativeValue], [int]
  dynamic doseValue;
  ...
  /// Create a new instance of [SchemaReportedDoseSchedule]
  SchemaReportedDoseSchedule({
    this.doseUnit,
    this.doseValue,
    this.frequency,
  ...
  /// Serialize [SchemaReportedDoseSchedule] to JSON-LD
  @override
  Map<String, dynamic> toJsonLd() => removeEmpty({
        '@context': 'https://schema.org',
        '@type': 'ReportedDoseSchedule',
        'doseUnit': convertToJsonLd(doseUnit, [String]),
        'doseValue': convertToJsonLd(doseValue, [SchemaQualitativeValue, int]),
        'frequency': convertToJsonLd(frequency, [String]),
