...
class SchemaResearchProject implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaResearchProject]
  SchemaResearchProject({
  ...
  /// Serialize [SchemaResearchProject] to JSON-LD
  @override
