...
/// //en.wikipedia.org/wiki/Resort</a>). <br /><br /> See also the <a
...
class SchemaResort implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaResort]
  SchemaResort({
    this.amenityFeature,
    this.audience,
  ...
  /// Serialize [SchemaResort] to JSON-LD
  @override
