...
class SchemaRiverBodyOfWater implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaRiverBodyOfWater]
  SchemaRiverBodyOfWater({
  ...
  /// Serialize [SchemaRiverBodyOfWater] to JSON-LD
  @override
