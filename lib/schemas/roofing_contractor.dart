...
class SchemaRoofingContractor implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaRoofingContractor]
  SchemaRoofingContractor({
    this.branchOf,
  ...
  /// Serialize [SchemaRoofingContractor] to JSON-LD
  @override
