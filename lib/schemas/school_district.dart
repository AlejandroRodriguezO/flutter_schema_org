...
class SchemaSchoolDistrict implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaSchoolDistrict]
  SchemaSchoolDistrict({
  ...
  /// Serialize [SchemaSchoolDistrict] to JSON-LD
  @override
