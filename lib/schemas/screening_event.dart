...
import 'package:flutter_schema_org/schemas/movie.dart';
...
class SchemaScreeningEvent implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaScreeningEvent]
  SchemaScreeningEvent({
  ...
  Map<String, dynamic> toJsonLd() => removeEmpty({
        ...
        'workPresented': convertToJsonLd(workPresented, [SchemaMovie]),
