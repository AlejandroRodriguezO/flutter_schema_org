...
class SchemaSeaBodyOfWater implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaSeaBodyOfWater]
  SchemaSeaBodyOfWater({
  ...
  /// Serialize [SchemaSeaBodyOfWater] to JSON-LD
  @override
