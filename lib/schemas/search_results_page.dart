...
class SchemaSearchResultsPage implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaSearchResultsPage]
  ...
  /// Serialize [SchemaSearchResultsPage] to JSON-LD
  @override
