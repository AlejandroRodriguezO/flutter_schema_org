...
class SchemaShoppingCenter implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaShoppingCenter]
  SchemaShoppingCenter({
    this.branchOf,
  ...
  /// Serialize [SchemaShoppingCenter] to JSON-LD
  @override
