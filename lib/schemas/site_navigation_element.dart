...
class SchemaSiteNavigationElement implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaSiteNavigationElement]
  SchemaSiteNavigationElement({
    this.cssSelector,
    this.xpath,
    this.about,
    this.abstract,
  ...
  /// Serialize [SchemaSiteNavigationElement] to JSON-LD
  @override
