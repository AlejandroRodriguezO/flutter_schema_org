...
import 'package:flutter_schema_org/schemas/computer_language.dart';
...
class SchemaSoftwareSourceCode implements SchemaSerializable {
  ...
  ///
  /// Supported types: [SchemaComputerLanguage], [String]
  dynamic programmingLanguage;

  /// Java v1, Python 2.3, .NET Framework 3.0).
  String? runtime;
  ...
  SchemaSoftwareApplication? targetProduct;
  ...
  /// Create a new instance of [SchemaSoftwareSourceCode]
  ...
  Map<String, dynamic> toJsonLd() => removeEmpty({
        ...
        'runtimePlatform': convertToJsonLd(runtimePlatform, [String]),
