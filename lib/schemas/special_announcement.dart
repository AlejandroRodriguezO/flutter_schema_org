...
import 'package:flutter_schema_org/schemas/civic_structure.dart';
import 'package:flutter_schema_org/schemas/local_business.dart';
import 'package:flutter_schema_org/schemas/category_code.dart';
import 'package:flutter_schema_org/schemas/physical_activity_category.dart';
import 'package:flutter_schema_org/schemas/thing.dart';
import 'package:flutter_schema_org/schemas/web_content.dart';
import 'package:flutter_schema_org/schemas/dataset.dart';
import 'package:flutter_schema_org/schemas/observation.dart';
import 'package:flutter_schema_org/schemas/government_service.dart';
import 'package:flutter_schema_org/schemas/data_feed.dart';
...
import 'package:flutter_schema_org/schemas/aggregate_rating.dart';
import 'package:flutter_schema_org/schemas/web_page.dart';
import 'package:flutter_schema_org/schemas/defined_term.dart';
import 'package:flutter_schema_org/schemas/media_object.dart';
import 'package:flutter_schema_org/schemas/audience.dart';
import 'package:flutter_schema_org/schemas/audio_object.dart';
import 'package:flutter_schema_org/schemas/clip.dart';
import 'package:flutter_schema_org/schemas/music_recording.dart';
import 'package:flutter_schema_org/schemas/organization.dart';
import 'package:flutter_schema_org/schemas/comment.dart';
import 'package:flutter_schema_org/schemas/place.dart';
import 'package:flutter_schema_org/schemas/rating.dart';
import 'package:flutter_schema_org/schemas/correction_comment.dart';
import 'package:flutter_schema_org/schemas/country.dart';
import 'package:flutter_schema_org/schemas/iptc_digital_source_enumeration.dart';
import 'package:flutter_schema_org/schemas/alignment_object.dart';
import 'package:flutter_schema_org/schemas/grant.dart';
import 'package:flutter_schema_org/schemas/language.dart';
import 'package:flutter_schema_org/schemas/interaction_counter.dart';
import 'package:flutter_schema_org/schemas/claim.dart';
import 'package:flutter_schema_org/schemas/product.dart';
import 'package:flutter_schema_org/schemas/quantitative_value.dart';
import 'package:flutter_schema_org/schemas/demand.dart';
import 'package:flutter_schema_org/schemas/offer.dart';
import 'package:flutter_schema_org/schemas/publication_event.dart';
import 'package:flutter_schema_org/schemas/event.dart';
import 'package:flutter_schema_org/schemas/review.dart';
import 'package:flutter_schema_org/schemas/size_specification.dart';
import 'package:flutter_schema_org/schemas/image_object.dart';
import 'package:flutter_schema_org/schemas/duration.dart';
import 'package:flutter_schema_org/schemas/video_object.dart';
...
/// //en.wikipedia.org/wiki/Atom_(Web_standard)) feed. For publishers without
/// such feeds, basic feed-like information can be shared by posting
/// [SchemaSpecialAnnouncement] updates in a page, e.g. using JSON-LD. For
/// sites with Atom/RSS functionality, you can point to a feed with the
/// [SchemawebFeed] property. This can be a simple URL, or an inline
/// [SchemaDataFeed] object, with [SchemaencodingFormat] providing media type
...
class SchemaSpecialAnnouncement implements SchemaSerializable {
  /// Indicates a specific [SchemaCivicStructure] or [SchemaLocalBusiness]
  ...
  /// region like a quarantine of an entire region, use
  /// [SchemaspatialCoverage].
  ///
  /// Supported types: [SchemaCivicStructure], [SchemaLocalBusiness]
  dynamic announcementLocation;
  ...
  ///
  /// Supported types: [String], [SchemaWebContent]
  dynamic diseasePreventionInfo;

  /// Statistical information about the spread of a disease, either as
  /// [SchemaWebContent], or described directly as a [SchemaDataset], or the
  /// specific [SchemaObservation]s in the dataset. When a [SchemaWebContent]
  /// URL is provided, the page indicated might also contain more such markup.
  ///
  /// Supported types: [SchemaDataset], [SchemaObservation], [String],
  /// [SchemaWebContent]
  dynamic diseaseSpreadStatistics;

  /// Information about getting tested (for a [SchemaMedicalCondition]), e.g.
  /// in the context of a pandemic.
  ///
  /// Supported types: [String], [SchemaWebContent]
  dynamic gettingTestedInfo;

  /// governmentBenefitsInfo provides information about government benefits
  /// associated with a SpecialAnnouncement.
  SchemaGovernmentService? governmentBenefitsInfo;

  /// Indicates a page with news updates and guidelines. This could often be
  /// (but is not required to be) the main page containing
  /// [SchemaSpecialAnnouncement] markup on a site.
  ///
  /// Supported types: [String], [SchemaWebContent]
  dynamic newsUpdatesAndGuidelines;

  /// Information about public transport closures.
  ///
  /// Supported types: [String], [SchemaWebContent]
  dynamic publicTransportClosuresInfo;

  /// Guidelines about quarantine rules, e.g. in the context of a pandemic.
  ///
  /// Supported types: [String], [SchemaWebContent]
  dynamic quarantineGuidelines;

  /// Information about school closures.
  ///
  /// Supported types: [String], [SchemaWebContent]
  dynamic schoolClosuresInfo;
  ...
  ///
  /// Supported types: [SchemaDataFeed], [String]
  dynamic webFeed;
  ...
  /// Create a new instance of [SchemaSpecialAnnouncement]
  SchemaSpecialAnnouncement({
    this.announcementLocation,
    this.category,
    this.datePosted,
    this.diseasePreventionInfo,
    this.diseaseSpreadStatistics,
    this.gettingTestedInfo,
    this.governmentBenefitsInfo,
    this.newsUpdatesAndGuidelines,
    this.publicTransportClosuresInfo,
    this.quarantineGuidelines,
    this.schoolClosuresInfo,
    this.travelBans,
    this.webFeed,
    this.about,
    this.abstract,
