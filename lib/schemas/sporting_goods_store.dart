...
class SchemaSportingGoodsStore implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaSportingGoodsStore]
  SchemaSportingGoodsStore({
    this.branchOf,
  ...
  /// Serialize [SchemaSportingGoodsStore] to JSON-LD
  @override
