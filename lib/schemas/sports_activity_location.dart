...
class SchemaSportsActivityLocation implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaSportsActivityLocation]
  SchemaSportsActivityLocation({
    this.branchOf,
  ...
  /// Serialize [SchemaSportsActivityLocation] to JSON-LD
  @override
