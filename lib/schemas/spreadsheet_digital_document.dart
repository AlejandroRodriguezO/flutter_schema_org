...
class SchemaSpreadsheetDigitalDocument implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaSpreadsheetDigitalDocument]
  SchemaSpreadsheetDigitalDocument({
  ...
  /// Serialize [SchemaSpreadsheetDigitalDocument] to JSON-LD
  @override
