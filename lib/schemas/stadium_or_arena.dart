...
class SchemaStadiumOrArena implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaStadiumOrArena]
  SchemaStadiumOrArena({
    this.openingHours,
    this.branchOf,
  ...
  /// Serialize [SchemaStadiumOrArena] to JSON-LD
  @override
