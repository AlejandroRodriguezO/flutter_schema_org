...
/// Unlike JoinAction, SubscribeAction implies that the agent is interested
/// in continuing receiving updates from the object.
/// See https://schema.org/SubscribeAction
class SchemaSubscribeAction implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaSubscribeAction]
  SchemaSubscribeAction({
    this.actionStatus,
    this.agent,
    this.endTime,
    this.error,
  ...
  /// Serialize [SchemaSubscribeAction] to JSON-LD
  @override
