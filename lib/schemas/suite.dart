...
/// //en.wikipedia.org/wiki/Suite_(hotel)</a>). <br /><br /> See also the <a
...
class SchemaSuite implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaSuite]
  SchemaSuite({
    this.bed,
    this.numberOfRooms,
    this.occupancy,
  ...
  /// Serialize [SchemaSuite] to JSON-LD
  @override
