...
class SchemaSurgicalProcedure implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaSurgicalProcedure]
  SchemaSurgicalProcedure({
    this.bodyLocation,
    this.followup,
    this.howPerformed,
    this.preparation,
  ...
  /// Serialize [SchemaSurgicalProcedure] to JSON-LD
  @override
