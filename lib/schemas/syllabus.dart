...
/// several such sections per [SchemaCourse] so that a distinct
/// [SchematimeRequired] can be provided for that section of the
/// [SchemaCourse].
/// See https://schema.org/Syllabus
class SchemaSyllabus implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaSyllabus]
  SchemaSyllabus({
    this.assesses,
  ...
  /// Serialize [SchemaSyllabus] to JSON-LD
  @override
