...
class SchemaTelevisionStation implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaTelevisionStation]
  SchemaTelevisionStation({
    this.branchOf,
  ...
  /// Serialize [SchemaTelevisionStation] to JSON-LD
  @override
