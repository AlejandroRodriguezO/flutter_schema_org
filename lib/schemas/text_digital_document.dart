...
class SchemaTextDigitalDocument implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaTextDigitalDocument]
  SchemaTextDigitalDocument({
  ...
  /// Serialize [SchemaTextDigitalDocument] to JSON-LD
  @override
