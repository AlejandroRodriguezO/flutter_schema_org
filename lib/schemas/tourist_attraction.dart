...
/// [SchemaTouristAttraction], from a [SchemaMountain] and
/// [SchemaLandmarksOrHistoricalBuildings] to a [SchemaLocalBusiness]. This
/// Type can be used on its own to describe a general
/// [SchemaTouristAttraction], or be used as an [SchemaadditionalType] to add
/// tourist attraction properties to any other type. (See examples below)
...
class SchemaTouristAttraction implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaTouristAttraction]
  SchemaTouristAttraction({
