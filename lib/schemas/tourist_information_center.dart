...
class SchemaTouristInformationCenter implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaTouristInformationCenter]
  SchemaTouristInformationCenter({
    this.branchOf,
  ...
  /// Serialize [SchemaTouristInformationCenter] to JSON-LD
  @override
