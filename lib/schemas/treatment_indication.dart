...
class SchemaTreatmentIndication implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaTreatmentIndication]
  SchemaTreatmentIndication({
    this.code,
    this.funding,
    this.guideline,
    this.legalStatus,
  ...
  /// Serialize [SchemaTreatmentIndication] to JSON-LD
  @override
