...
import 'package:flutter_schema_org/schemas/tv_series.dart';
...
import 'package:flutter_schema_org/schemas/creative_work_season.dart';
import 'package:flutter_schema_org/schemas/creative_work_series.dart';
...
class SchemaTVEpisode implements SchemaSerializable {
  ...
  /// representing at the most general/abstract level, a work of film or
  /// television.
  ///
  ...
  /// several variants, which EIDR calls "edits". See [SchemaeditEIDR].
  ///
  /// Since schema.org types like [SchemaMovie], [SchemaTVEpisode],
  /// [SchemaTVSeason], and [SchemaTVSeries] can be used for both works and
  /// their multiple expressions, it is possible to use [SchematitleEIDR] alone
  /// (for a general description), or alongside [SchemaeditEIDR] for a more
  ...
  SchemaCreativeWorkSeason? partOfSeason;

  /// The series to which this episode or season belongs.
  SchemaCreativeWorkSeries? partOfSeries;
  ...
  /// Create a new instance of [SchemaTVEpisode]
  SchemaTVEpisode({
  ...
  Map<String, dynamic> toJsonLd() => removeEmpty({
        ...
        'titleEIDR': convertToJsonLd(titleEIDR, [String, String]),
        ...
        'episodeNumber': convertToJsonLd(episodeNumber, [String, int]),
        'musicBy': convertToJsonLd(musicBy, [SchemaMusicGroup, SchemaPerson]),
        'partOfSeason':
            convertToJsonLd(partOfSeason, [SchemaCreativeWorkSeason]),
        'partOfSeries':
            convertToJsonLd(partOfSeries, [SchemaCreativeWorkSeries]),
        'productionCompany':
