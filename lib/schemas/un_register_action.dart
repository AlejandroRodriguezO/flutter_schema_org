...
class SchemaUnRegisterAction implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaUnRegisterAction]
  SchemaUnRegisterAction({
    this.actionStatus,
    this.agent,
    this.endTime,
    this.error,
  ...
  /// Serialize [SchemaUnRegisterAction] to JSON-LD
  @override
