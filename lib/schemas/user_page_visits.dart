...
/// interacting with pages. It is generally better to use
/// [SchemaAction]-based vocabulary, alongside types such as [SchemaComment].
/// See https://schema.org/UserPageVisits
class SchemaUserPageVisits implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaUserPageVisits]
  SchemaUserPageVisits({
    this.about,
    this.actor,
  ...
  /// Serialize [SchemaUserPageVisits] to JSON-LD
  @override
