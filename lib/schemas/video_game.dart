...
import 'package:flutter_schema_org/schemas/game_server.dart';
import 'package:flutter_schema_org/schemas/music_group.dart';
import 'package:flutter_schema_org/schemas/game_play_mode.dart';
...
import 'package:flutter_schema_org/schemas/software_application.dart';
...
class SchemaVideoGame implements SchemaSerializable {
  ...
  SchemaPerson? directors;

  /// The edition of a video game.
  String? gameEdition;

  /// Video_game_platforms">video games</a>.
  ///
  /// Supported types: [String], [String], [SchemaThing]
  dynamic gamePlatform;

  /// The server on which it is possible to play the game.
  SchemaGameServer? gameServer;

  /// Links to tips, tactics, etc.
  SchemaCreativeWork? gameTip;

  /// The composer of the soundtrack.
  ///
  /// Supported types: [SchemaMusicGroup], [SchemaPerson]
  dynamic musicBy;
  ...
  /// time.
  SchemaGamePlayMode? playMode;

  /// The trailer of a movie or TV/radio series, season, episode, etc.
  SchemaVideoObject? trailer;
  ...
  SchemaThing? characterAttribute;
  ...
  SchemaQuantitativeValue? numberOfPlayers;
  ...
  SchemaSoftwareApplication? softwareAddOn;

  /// Software application help.
  SchemaCreativeWork? softwareHelp;
  ...
  /// Create a new instance of [SchemaVideoGame]
  SchemaVideoGame({
    this.actor,
    this.actors,
    this.cheatCode,
  ...
  Map<String, dynamic> toJsonLd() => removeEmpty({
        ...
        'gamePlatform':
            convertToJsonLd(gamePlatform, [String, String, SchemaThing]),
        ...
        'applicationCategory':
            convertToJsonLd(applicationCategory, [String, String]),
        'applicationSubCategory':
            convertToJsonLd(applicationSubCategory, [String, String]),
        ...
        'featureList': convertToJsonLd(featureList, [String, String]),
        'fileSize': convertToJsonLd(fileSize, [String]),
        'installUrl': convertToJsonLd(installUrl, [String]),
        'memoryRequirements':
            convertToJsonLd(memoryRequirements, [String, String]),
        'operatingSystem': convertToJsonLd(operatingSystem, [String]),
        'permissions': convertToJsonLd(permissions, [String]),
        'processorRequirements':
            convertToJsonLd(processorRequirements, [String]),
        'releaseNotes': convertToJsonLd(releaseNotes, [String, String]),
        'requirements': convertToJsonLd(requirements, [String, String]),
        ...
        'softwareRequirements':
            convertToJsonLd(softwareRequirements, [String, String]),
        'softwareVersion': convertToJsonLd(softwareVersion, [String]),
        'storageRequirements':
            convertToJsonLd(storageRequirements, [String, String]),
