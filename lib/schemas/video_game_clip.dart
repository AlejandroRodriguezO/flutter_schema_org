...
import 'package:flutter_schema_org/schemas/hyper_toc_entry.dart';
import 'package:flutter_schema_org/schemas/music_group.dart';
import 'package:flutter_schema_org/schemas/episode.dart';
...
class SchemaVideoGameClip implements SchemaSerializable {
  ...
  ///
  /// Supported types: [SchemaHyperTocEntry], [int]
  dynamic endOffset;
  ...
  /// Create a new instance of [SchemaVideoGameClip]
  SchemaVideoGameClip({
    this.actor,
    this.actors,
    this.clipNumber,
  ...
  /// Serialize [SchemaVideoGameClip] to JSON-LD
  @override
  Map<String, dynamic> toJsonLd() => removeEmpty({
        ...
        'clipNumber': convertToJsonLd(clipNumber, [String, int]),
        'director': convertToJsonLd(director, [SchemaPerson]),
        'directors': convertToJsonLd(directors, [SchemaPerson]),
        'endOffset': convertToJsonLd(endOffset, [SchemaHyperTocEntry, int]),
        'musicBy': convertToJsonLd(musicBy, [SchemaMusicGroup, SchemaPerson]),
        'partOfEpisode': convertToJsonLd(partOfEpisode, [SchemaEpisode]),
        'partOfSeason':
