...
/// A specific and exact (byte-for-byte) version of a [SchemaVideoObject].
/// Two byte-for-byte identical files, for the purposes of this type,
/// considered identical. If they have different embedded metadata the files
...
class SchemaVideoObjectSnapshot implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaVideoObjectSnapshot]
  SchemaVideoObjectSnapshot({
    this.actor,
    this.actors,
    this.caption,
    this.director,
