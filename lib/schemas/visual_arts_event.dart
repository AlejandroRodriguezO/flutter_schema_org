...
class SchemaVisualArtsEvent implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaVisualArtsEvent]
  SchemaVisualArtsEvent({
    this.about,
    this.actor,
  ...
  /// Serialize [SchemaVisualArtsEvent] to JSON-LD
  @override
