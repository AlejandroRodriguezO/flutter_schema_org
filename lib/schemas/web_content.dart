...
/// WebContent is a type representing all [SchemaWebPage], [SchemaWebSite]
/// and [SchemaWebPageElement] content. It is sometimes the case that
/// detailed distinctions between Web pages, sites and their parts are not
/// always important or obvious. The [SchemaWebContent] type makes it easier
/// to describe Web-addressable content without requiring such distinctions
/// to always be stated. (The intent is that the existing types
/// [SchemaWebPage], [SchemaWebSite] and [SchemaWebPageElement] will
/// eventually be declared as subtypes of [SchemaWebContent].)
...
class SchemaWebContent implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaWebContent]
  SchemaWebContent({
    this.about,
    this.abstract,
    this.accessMode,
