...
class SchemaWholesaleStore implements SchemaSerializable {
  ...
  /// Create a new instance of [SchemaWholesaleStore]
  SchemaWholesaleStore({
    this.branchOf,
  ...
  /// Serialize [SchemaWholesaleStore] to JSON-LD
  @override
